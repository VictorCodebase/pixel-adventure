...
//! Controls here
  ...
  void _goToNextLevel() {
    const throttleDuration = Duration(milliseconds: 6500);
    levelComplete = true;
    ...
    if (lastThrottle == null || DateTime.now().difference(lastThrottle!) > throttleDuration){
      func();
